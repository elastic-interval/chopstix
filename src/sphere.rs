...
impl SphereScaffold {
    pub fn new(frequency: usize) -> SphereScaffold {
        SphereScaffold {
            frequency,
            vertex: Vec::with_capacity(frequency * frequency * 10 + 2),
        }
    }
            ...
            _ => {
                ...
                let edge_v = EDGE.map(|[a, b]| {
                    ...
                    for walk_usize in 0..self.frequency - 1 {
                        ...
                        let location = self.vertex[a]
                            .location
                            .lerp(self.vertex[b].location, amount);
                    ...
                    .for_each(|(face_index, face_v)| {
                        ...
                        for side in 0..side_vertices.len() {
                            ...
                            for edge_vertex in 0..face_v.len() {
                                ...
                                self.beside(
                                    side_vertices[side][edge_vertex],
                                    edge[edge_vertex + 1],
                                );
                            }
                        }
                ...
                for pentagon_vertex in PENTAGON_VERTICES {
                    for a in 0..pentagon_vertex.len() {
                        ...
                        let end_of_edge = |x: usize| {
                            if pentagon_vertex[x].1 {
                                0
                            } else {
                                self.frequency - 2
                            }
...
const PENTAGON_VERTICES: [[(usize, bool); 5]; 12] = [
